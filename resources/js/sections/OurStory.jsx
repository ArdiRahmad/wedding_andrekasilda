                        ...
                        <div className="w-full h-60 overflow-hidden relative">
                            ...
                            <div className="absolute top-0 bottom-0 z-10 flex items-center justify-center px-14 flex-col">
                                ...
                                <p className="text-xs text-white text-center font-dancing">
                                    Berawal dari pertemuan di SMA saat itu
                                    kasilda adalah Adik kelas dari andre. Kami
                                    pertama kali berkenalan di acara reat reat
                                    yang diadakan di SMA kami. Saat SMA dan awal
                                    berkuliah di kampus masing masing awalnya
                                    kami tidak ada keterikatan satu dengan yang
                                    lain. Hingga saat kuliah kami mulai
                                    berhubungan kembali melalui sosial media dan
                                    menjalani masa pacaran hingga sekarang.
                                </p>
                            </div>
