                ...
                <div className="w-full max-w-lg backdrop-blur  shadow-xl overflow-hidden">
                    <div className="text-center">
                        <div className="w-full h-60 overflow-hidden relative z-10">
                            {/* TEXT */}
                            <div className="absolute top-0 bottom-0 z-20 flex items-center justify-center px-10 flex-col w-full">
                ...
                <p className="text-xs text-white text-center font-dancing mb-6">
                  ...
                  bermanfaat bagi kami dalam mengarungi bahtera rumah tangga
                                ...
                                <button
                                    ...
                                    className="event-button bg-brown-dark px-14 py-2 text-white text-xs flex gap-2 items-center"
                                >
                                    <FaGift />
                                    GIFT
                                </button>
            ...
            >
                ...
                >
                    ...
                    {accounts.map((item, i) => (
                        <div
                            key={i}
                            className="p-3 border mb-3 rounded-lg font-content"
                        >
