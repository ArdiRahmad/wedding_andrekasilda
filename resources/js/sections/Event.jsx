...
function Event({ type }) {
    const weddingDate = new Date("2026-06-06T09:00:00").getTime();
                ...
                <div className="relative z-10 px-10 py-14">
                    ...
                    <div className="event-block mb-24">
                        ...
                        <p className="title font-content text-md font-medium text-brown">
                            PUKUL{" "}
                            {type == "mrn" ? "12.30 - 14.30" : "14.00 - 16.00"}{" "}
                            WIB
                        </p>
                        ...
                        <a
                            target="_blank"
                            href="https://maps.app.goo.gl/nEb4qVEyzLEyTiwy8"
                    ...
                    <div className="event-block mb-20">
                        ...
                        <a
                            href="https://maps.app.goo.gl/pFZzGEkmTm9ZHiky9"
                            target="_blank"
                            className="event-button bg-brown-dark px-14 py-2 text-white text-xs"
                        >
                            LOKASI
                    ...
                    <p className="footer font-content text-xs text-brown">
                        ATAS KEHADIRAN DAN DOA RESTU KAMI MENGUCAPKAN TERIMA
                        KASIH
                    </p>
                </div>
            </div>
